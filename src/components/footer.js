...
const Footer = () => {
    ...
    return (
    <div lassName="container-fluid text-center align-items-center" id="footer">
      <div className="container text-center align-items-center">
        <span id="htxt">IET MPSTME ON CAMPUS</span>
      </div>
      <div className="row">
        <div className="col-12 col-md-4 text-center align-itmes-center">
        ...
        <div className="col-12 col-md-4 text-dark text-justify py-3 px-5">
          ...
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut ad
